...
export const zhHant = {
	ui: {
		...
		system: '系統',
		systemTitle: '顯示與文字',
		systemLanguageHint: '介面與對話',
		railDisplay: '顯示',
		railAudio: '音效',
		railInput: '輸入',
		audioUnavailable: '此版本尚未提供音效設定。',
		textSpeed: '文字速度',
		textSpeedHint: '對話顯示速度',
		speedSlow: '慢速',
		speedNormal: '普通',
		speedInstant: '即時',
		hudDensity: 'HUD 資訊量',
		hudDensityHint: '畫面顯示的資訊量',
		densityQuiet: '簡潔',
		densityFull: '完整',
		densityFullUnavailable: '完整資訊量尚未開放。',
		motion: '動態效果',
		motionHint: '光效、掃過與脈動',
		motionOn: '開啟',
		motionReduced: '減少',
		prompts: '操作提示',
		promptsHint: '要顯示的按鍵圖示類型',
		promptAuto: '自動',
		promptPad: '手把',
		promptKeys: '鍵盤',
		quests: '任務',
		...
		titleNoSaveData: '沒有儲存資料',
		titleHintSelect: '選擇',
		titleHintEnter: '確認',
		titleNewRunConfirm: '開始新的旅程？自動儲存將被覆寫。',
		saveScreen: '儲存',
		loadScreen: '讀取',
		waystone: '路石',
		slotAutosave: '自動儲存',
		...
		shopDimmedHint: '暗色＝金額不足',
		shopPurse: '錢包',
		shopPurseAfter: '購買後錢包',
		shopNotEnough: '金額不足',
		soldOut: '已售罄',
		shopReplaces: '取代{{slot}} · {{current}}',
		shopEmptySlot: '空位',
	...
	status: {
		...
		saved: '已存檔',
		savedWithoutThumbnail: '已存檔（無預覽圖）',
		saveFailed: '無法存檔',
		saveResumed: '已讀取存檔',
		enteredArea: '已進入區域',
		newRun: '新旅程',
