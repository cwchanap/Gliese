...
export const ja = {
	ui: {
		...
		system: 'システム',
		systemTitle: '表示とテキスト',
		systemLanguageHint: 'インターフェースと会話',
		railDisplay: '表示',
		railAudio: '音声',
		railInput: '入力',
		audioUnavailable: 'このビルドでは音声設定を利用できません。',
		textSpeed: 'テキスト速度',
		textSpeedHint: '会話の表示速度',
		speedSlow: 'ゆっくり',
		speedNormal: 'ふつう',
		speedInstant: '即時',
		hudDensity: 'HUD表示量',
		hudDensityHint: 'フィールドの表示範囲',
		densityQuiet: '簡素',
		densityFull: '詳細',
		densityFullUnavailable: '詳細表示はまだ利用できません。',
		motion: 'モーション',
		motionHint: '光の演出やアニメーション',
		motionOn: 'オン',
		motionReduced: '控えめ',
		prompts: '操作表示',
		promptsHint: '表示するボタンの種類',
		promptAuto: '自動',
		promptPad: 'パッド',
		promptKeys: 'キーボード',
		quests: '依頼',
		...
		titleNoSaveData: 'セーブデータなし',
		titleHintSelect: '決定',
		titleHintEnter: '進む',
		titleNewRunConfirm: '新しい冒険をはじめますか？オートセーブは上書きされます。',
		saveScreen: 'セーブ',
		loadScreen: 'ロード',
		waystone: 'ウェイストーン',
		slotAutosave: 'オートセーブ',
		...
		shopDimmedHint: '暗表示＝購入不可',
		shopPurse: '所持金',
		shopPurseAfter: '購入後の所持金',
		shopNotEnough: 'コインが足りない',
		soldOut: '売り切れ',
		shopReplaces: '{{slot}}を置き換え · {{current}}',
		shopEmptySlot: '空き',
	...
	status: {
		...
		saved: 'セーブした',
		savedWithoutThumbnail: 'プレビュー画像なしでセーブしました',
		saveFailed: 'セーブできませんでした',
