...
export const sundropVillageLayered: LayeredRegionSource<(typeof villageDressingAsset)['key']> = {
	...
	layers: {
		...
		// HPA-238 v2 open layout (human visual gate: "still too crowded / open up
		// interior walls"). The village was eight hedge-walled compartments, which
		// read as cramped; it is now three open bands separated by two horizontal
		// hedge lines with wide street gaps. North band (rows 4-18) holds the two
		// market houses + guild hall; central band (rows 20-31) is the plaza/well
		// commons; south band (rows 33-45) holds the home yard + shrine garden.
		// Row 19 and row 32 are the hedge lines; every solid run is >=3 wide (A4)
		// and the street gaps keep all rooms mutually reachable (A1 room adjacency).
		collision: [
			'.....................................#...........#......',
			'.....................................#...........#......',
			'..####################################...........####...',
