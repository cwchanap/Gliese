...
- explicit non-invocation for story-only, placement-only, and asset-only work; a lightweight `frozen-integration` skill route that consumes approved geometry and art and skips redesign and production;
